...
ctab_stats <- cyearly_stats %>%
 ...
 mutate(
  name = case_when(
   ...
   startsWith(tolower(index_rate),"spt") ~ "Severe Perineal Trauma with <br> Spontaneous Vaginal Birth",
   startsWith(tolower(index_rate),"med") ~ "Mediolateral Episiotomy with <br> Operative Vaginal Birth",
   startsWith(tolower(index_rate),"sptassvgmed_rate") ~ "Severe Perineal Trauma with <br> Operative Vaginal Birth and <br> mediolateral episiotomy",
   startsWith(tolower(index_rate),"sptassvgnmed_rate") ~ "Severe Perineal Trauma with <br> Operative Vaginal Birth without <br> mediolateral episiotomy",
   startsWith(tolower(index_rate),"pphbl") ~ "Postpartum hemorrhage treated with <br> a blood transfusion",
   startsWith(tolower(index_rate),"pphpi") ~ "Postpartum hemorrhage resulting in <br> procedural intervention",
   startsWith(tolower(index_rate),"pphiv") ~ "Postpartum blood products amongst <br> those who received <br> antenatal iron therapy",
   startsWith(tolower(index_rate),"pretster") ~ "Preterm infants who <br> received steroids <br> prior to birth ",
   startsWith(tolower(index_rate),"pretnnicu") ~ "Preterm infants born <br> in facility without NICU",
   startsWith(tolower(index_rate),"newlwcs") ~ "Newborn respiratory distress <br> associated with low-risk repeat Caesarean <br> at term gestation",
   ...
   startsWith(tolower(index_rate),"delcordtermvg_rate") ~ "Delayed Cord Clamping amongst Term Newborns <br> after Spontaneous Vaginal Birth",
   startsWith(tolower(index_rate),"delcordtermcs_rate") ~ "Delayed Cord Clamping amongst Term Newborns <br> after Caesarean Birth",
   startsWith(tolower(index_rate),"delcordpreterm_rate") ~ "Delayed Cord Clamping amongst Preterm Newborns",
   startsWith(tolower(index_rate),"delcordpretermvg_rate") ~ "Delayed Cord Clamping amongst Preterm Newborns <br> after Spontaneous Vaginal Birth",
   startsWith(tolower(index_rate),"delcordpretermcs_rate") ~ "Delayed Cord Clamping amongst Preterm Newborns <br> after Caesarean Birth",
